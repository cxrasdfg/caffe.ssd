...
redo = True
# The caffe root.
CAFFE_ROOT = "{}/workspace/detection/ssd/SSD-CAFFE/caffe.ssd".format(HOMEDIR)
...
#anno_sets = ["image_info_test-dev2017", "instances_minival2017"]
anno_sets = ["instances_val2017"]
